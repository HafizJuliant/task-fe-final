...
const createAccount = async () => {
  try {
    const response = await axios.post('http://localhost:8081/account/create', currentAccount.value);
...
const updateAccount = async () => {
  try {
    const response = await axios.patch(`http://localhost:8081/account/update/${currentAccount.value.account_id}`, currentAccount.value);
